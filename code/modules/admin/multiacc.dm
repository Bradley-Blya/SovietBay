/client/proc/checkAccount()
	...
	switch(alert("Chose checktype",,"All","Select player","Type ckey","Cancel"))
		...
		if("Type ckey")
			var/target = ckey(input(usr, "Iaia?aoaeoa ckey, eioi?ue io?ii i?iaa?eou.", "Ckey") as text|null)
			if(!target) //Cancel oaia?u ?aaioaao
				return
			holder.showAccounts(target)

/datum/admins/proc/showAccounts(var/targetkey)
	var/size = 0
	var/output = "<center><table border='1'> <caption>Niaiaaaiea ii computerID</caption><tr> <th width='100px' >ckey</th><th width='100px'>firstseen</th><th width='100px'>lastseen</th><th width='100px'>ip</th><th width='100px'>computerid </th></tr>"
	...
	output += "<center><table border='1'> <caption>Niaiaaaiea ii IP</caption><tr> <th width='100px' >ckey</th><th width='100px'>firstseen</th><th width='100px'>lastseen</th><th width='100px'>ip</th><th width='100px'>computerid </th></tr>"
...
/datum/admins/proc/checkAllAccounts()
	var/DBQuery/query
	var/t1 = ""
	var/output = "<B>Niaiaaaiea ii IP</B><BR><BR>"
	...
	output+= "<BR><BR><B>Niaiaaaiea ii computerID</B><BR><BR>"
